...
import com.example.ac.entity.ScshtjDO;
...
public interface SCSHTJMapper {
    ...
    @Select("SELECT id,fid,gdmj,ldmj,tghlmj,lgmj,mcdmj,smmj,sfjrnmzyhzs,sfyltqybz,sfycyzfdtrdd,sftshyd,sftgbds,sfjjaqyys,sfywscs,yczgljl,rhllx,zfmj,sfwf,wfdj,wgnd,zyrllx,jtrlmc,lrrq,gxrq,scbz FROM ym_jtjbqk_scshtj WHERE id = #{id}")
    int get(int id);
}
